function Team() {
  return (
    <section id="team" className="text-gray-400 body-font bg-gray-800">
          ...
          <div className="p-4 lg:w-1/4 md:w-1/2">
            <div className="h-full flex flex-col items-center text-center">
              ...
              <div className="w-full">
                ...
                <h3 className="text-gray-400 mb-3">Founder</h3>
                <span className="inline-flex">
                  ...
                  <a className="ml-2 text-gray-400 hover:text-gray-200">
                    <svg
                      fill="none"
                      stroke="currentColor"
                      stroke-linecap="round"
          ...
          <div className="p-4 lg:w-1/4 md:w-1/2">
            <div className="h-full flex flex-col items-center text-center">
              ...
              <div className="w-full">
                ...
                <h3 className="text-gray-400 mb-3">Senior Engineer</h3>
                <span className="inline-flex">
                  <a className="text-gray-400 hover:text-gray-200">
                    <svg
                      fill="none"
          ...
          <div className="p-4 lg:w-1/4 md:w-1/2">
            <div className="h-full flex flex-col items-center text-center">
              ...
              <div className="w-full">
                ...
                <h3 className="text-gray-400 mb-3">Project Manager</h3>
                <span className="inline-flex">
                  <a className="text-gray-400 hover:text-gray-200">
                    <svg
                      fill="none"
